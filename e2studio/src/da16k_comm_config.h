...
/*  Common ATCMD Library config file for all RA6Mx platforms

    The project file must define one of the following:
        DA16K_CONFIG_EK_RA6M4
        DA16K_CONFIG_CK_RA6M5

    The project MUST also define the following value:
